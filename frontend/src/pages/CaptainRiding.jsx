...
const CaptainRiding = () => {
  ...
  return (
    <div className="h-screen">
      ...
      <button className=' bg-green-600 text-white font-semibold p-3 px-14 rounded-lg'>Complete Ride</button>
      </div>

      <div ref={finishRidePanelRef}  className="fixed bottom-0 z-10 p-3 bg-white w-full px-3 py-10 pt-12 translate-y-full">
